...
3. Effúnde frámeam, et conclúde advérsus eos, qui \textbf{per}se\textbf{quún}\textbf{tur} me:~*  dic ánimæ meæ: Salus \textit{tu}\textit{a} \textbf{e}go sum.\
...
7. Fiat via illórum téne\textbf{bræ} et \textbf{lú}\textbf{bri}cum:~*  et Angelus Dómini pér\textit{se}\textit{quens} \textbf{e}os.\
...
10. Anima autem mea exsul\textbf{tá}bit in \textbf{Dó}\textbf{mi}no:~*  et delectábitur super salu\textit{tá}\textit{ri} \textbf{su}o.\
...
20. Dómine, \textbf{quan}do re\textbf{spí}\textbf{ci}es?~*  restítue ánimam meam a malignitáte eórum, a leónibus ú\textit{ni}\textit{cam} \textbf{me}am.\
...
25. Vidísti, Dómi\textbf{ne}, ne \textbf{sí}\textbf{le}as:~*  Dómine, ne di\textit{scé}\textit{das} \textbf{a} me.\
...
30. Induántur confusióne et \textbf{re}ve\textbf{rén}\textbf{ti}a~*  qui magna lo\textit{quún}\textit{tur} \textbf{su}per me.\
...
33. Glória \textbf{Pa}tri, et \textbf{Fí}\textbf{li}o,~*  et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.\
