2. Dicant qui redémpti sunt a Dómino, quos redémit de manu \textbf{in}i\textbf{mí}ci:~*  et de regiónibus congre\textit{gá}\textit{vit} \textbf{e}os:\
...
16. Quia contrívit \textbf{por}tas \textbf{ǽ}\textbf{re}as:~*  et vectes férre\textit{os} \textit{con}\textbf{fré}git.\
...
23. Qui descéndunt \textbf{ma}re in \textbf{ná}\textbf{vi}bus,~*  faciéntes operatiónem in \textit{a}\textit{quis} \textbf{mul}tis.\

24. Ipsi vidérunt \textbf{ó}pera \textbf{Dó}\textbf{mi}ni,~*  et mirabília ejus \textit{in} \textit{pro}\textbf{fún}do.\
...
27. Turbáti sunt, et moti sunt \textbf{sic}ut \textbf{é}\textbf{bri}us:~*  et omnis sapiéntia eórum \textit{de}\textit{vo}\textbf{rá}ta est.\
...
34. Terram fructíferam \textbf{in} sal\textbf{sú}\textbf{gi}nem:~*  a malítia inhabitánti\textit{um} \textit{in} \textbf{e}a.\
...
37. Et seminavérunt agros, et planta\textbf{vé}runt \textbf{ví}\textbf{ne}as:~*  et fecérunt fructum na\textit{ti}\textit{vi}\textbf{tá}tis.\

38. Et benedíxit eis, et multipli\textbf{cá}ti sunt \textbf{ni}mis:~*  et juménta eórum non \textit{mi}\textit{no}\textbf{rá}vit.\

39. Et \textbf{pau}ci \textbf{fac}\textbf{ti} sunt:~*  et vexáti sunt a tribulatióne malórum, \textit{et} \textit{do}\textbf{ló}re.\

40. Effúsa est contémptio \textbf{su}per \textbf{prín}\textbf{ci}pes:~*  et erráre fecit eos in ínvio, et \textit{non} \textit{in} \textbf{vi}a.\

41. Et adjúvit páuperem \textbf{de} in\textbf{ó}\textbf{pi}a:~*  et pósuit sicut o\textit{ves} \textit{fa}\textbf{mí}lias.\
...
44. Glória \textbf{Pa}tri, et \textbf{Fí}\textbf{li}o,~*  et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.\
