...
3. Conféssio et magnificéntia \textbf{o}pus \textbf{e}jus: \ast\  et justítia ejus manet in sǽ\textit{cu}\textit{lum} \textbf{sǽ}\textbf{cu}li.\
...
6. Ut det illis heredi\textbf{tá}tem \textbf{gén}tium: \ast\  ópera mánuum ejus véritas, \textit{et} \textit{ju}\textbf{dí}\textbf{ci}um.\
...
9. Sanctum, et terríbile \textbf{no}men \textbf{e}jus: \ast\  inítium sapiéntiæ \textit{ti}\textit{mor} \textbf{Dó}\textbf{mi}ni.\

10. Intelléctus bonus ómnibus faci\textbf{én}tibus \textbf{e}um: \ast\  laudátio ejus manet in sǽ\textit{cu}\textit{lum} \textbf{sǽ}\textbf{cu}li.\
