2. In die tribulatiónis meæ Deum exquisívi, \dag\  mánibus meis nocte \textit{con}\textit{tra} \textbf{e}um:~*  et \textit{non} \textit{sum} \textit{de}\textbf{cép}tus.\
...
13. Deus, in sancto via tua: \dag\  quis Deus magnus sicut \textit{De}\textit{us} \textbf{nos}ter?~*  tu es Deus qui fa\textit{cis} \textit{mi}\textit{ra}\textbf{bí}lia.\
