...
4. Accíngere gládio tuo super \textit{fe}\textit{mur} \textbf{tu}um, \ast\  \textit{pot}\textit{en}\textbf{tís}sime.\
...
15. Omnis glória ejus fíliæ Re\textit{gis} \textit{ab} \textbf{in}tus, \ast\  in fímbriis áureis circumamícta \textit{va}\textit{ri}\textit{e}\textbf{tá}tibus.\
...
20. Proptérea pópuli confitebúntur tibi \textit{in} \textit{æ}\textbf{tér}num: \ast\  et in \textit{sǽ}\textit{cu}\textit{lum} \textbf{sǽ}culi.\
