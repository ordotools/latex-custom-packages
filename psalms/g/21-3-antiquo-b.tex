2. Deus meus, clamábo per diem, et \textbf{non} ex\textbf{áu}\textbf{di}es: \ast\  et nocte, et non ad insipi\textbf{én}tiam \textbf{mi}hi.\

3. Tu autem in \textbf{sanc}to \textbf{há}\textbf{bi}tas: \ast\  laus \textbf{Is}raël.\

4. In te speravérunt \textbf{pa}tres \textbf{nos}tri: \ast\  speravérunt, et libe\textbf{rás}ti \textbf{e}os.\

5. Ad te clamavérunt, et \textbf{sal}vi \textbf{fac}\textbf{ti} sunt: \ast\  in te speravérunt, et non \textbf{sunt} con\textbf{fú}si.\

6. Ego autem sum vermis, \textbf{et} non \textbf{ho}mo: \ast\  oppróbrium hóminum, et ab\textbf{jéc}tio \textbf{ple}bis.\

7. Omnes vidéntes me \textbf{de}ri\textbf{sé}\textbf{runt} me: \ast\  locúti sunt lábiis, et mo\textbf{vé}runt \textbf{ca}put.\
...
14. Sicut \textbf{a}qua ef\textbf{fú}\textbf{sus} sum: \ast\  et dispérsa sunt ómnia \textbf{os}sa \textbf{me}a.\
...
19. Ipsi vero consideravérunt et \textbf{in}spe\textbf{xé}\textbf{runt} me: \ast\  divisérunt sibi vestiménta mea, et super vestem meam mi\textbf{sé}runt \textbf{sor}tem.\
...
25. Tímeat eum omne \textbf{se}men \textbf{Is}\textbf{ra}ël: \ast\  quóniam non sprevit, neque despéxit deprecati\textbf{ó}nem \textbf{páu}peris:\
...
29. Reminiscéntur et conver\textbf{tén}tur ad \textbf{Dó}\textbf{mi}num \ast\  univérsi \textbf{fi}nes \textbf{ter}ræ:\
...
35. Glória \textbf{Pa}tri, et \textbf{Fí}\textbf{li}o, \ast\  et Spi\textbf{rí}tui \textbf{Sanc}to.\
