...
9. Quóniam ipse \textbf{di}xit, et \textbf{fac}ta sunt: \ast\  ipse mandávit, \textit{et} \textit{cre}\textbf{á}\textbf{ta} sunt.\

10. Dóminus díssipat consília Géntium: \dag\  réprobat autem cogitatiónes \textbf{po}pu\textbf{ló}rum, \ast\  et réprobat consí\textit{li}\textit{a} \textbf{prín}\textbf{ci}pum.\
...
13. De cælo re\textbf{spé}xit \textbf{Dó}minus: \ast\  vidit omnes fí\textit{li}\textit{os} \textbf{hó}\textbf{mi}num.\
...
17. Fallax equus \textbf{ad} sa\textbf{lú}tem: \ast\  in abundántia autem virtútis suæ \textit{non} \textit{sal}\textbf{vá}\textbf{bi}tur.\
...
20. Anima nostra \textbf{sús}tinet \textbf{Dó}minum: \ast\  quóniam adjútor et pro\textit{téc}\textit{tor} \textbf{nos}\textbf{ter} est.\

21. Quia in eo lætábi\textbf{tur} cor \textbf{nos}trum: \ast\  et in nómine sancto e\textit{jus} \textit{spe}\textbf{rá}\textbf{vi}mus.\
