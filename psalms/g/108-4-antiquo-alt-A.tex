2. Locúti sunt advérsum me lingua dolósa, \dag\  et sermónibus ódii cir\textit{cum}\textit{de}\textbf{dé}runt me: \ast\  et expugna\textit{vé}\textit{runt} \textit{me} \textbf{gra}tis.\
...
8. Fiant fílii \textit{e}\textit{jus} \textbf{ór}phani: \ast\  et u\textit{xor} \textit{e}\textit{jus} \textbf{ví}dua.\
...
14. Fiant contra Dóminum semper, \dag\  et dispéreat de terra memóri\textit{a} \textit{e}\textbf{ó}rum: \ast\  pro eo quod non est recordátus fácere \textit{mi}\textit{se}\textit{ri}\textbf{cór}diam.\
...
16. Et diléxit maledictiónem, et vé\textit{ni}\textit{et} \textbf{e}i: \ast\  et nóluit benedictiónem, et elongá\textit{bi}\textit{tur} \textit{ab} \textbf{e}o.\
...
18. Fiat ei sicut vestiméntum, quo \textit{o}\textit{pe}\textbf{rí}tur: \ast\  et sicut zona, qua \textit{sem}\textit{per} \textit{præ}\textbf{cín}gitur.\
...
21. Líbera me quia egénus, et \textit{pau}\textit{per} \textbf{e}go sum: \ast\  et cor meum contur\textit{bá}\textit{tum} \textit{est} \textbf{in}tra me.\
...
23. Génua mea infirmáta sunt \textit{a} \textit{je}\textbf{jú}nio: \ast\  et caro mea immutáta \textit{est} \textit{prop}\textit{ter} \textbf{ó}leum.\
...
27. Maledícent illi, et tu benedíces: \dag\  qui insúrgunt in me, \textit{con}\textit{fun}\textbf{dán}tur: \ast\  servus autem \textit{tu}\textit{us} \textit{læ}\textbf{tá}bitur.\
...
31. Glória Pa\textit{tri}, \textit{et} \textbf{Fí}lio, \ast\  et Spi\textit{rí}\textit{tu}\textit{i} \textbf{Sanc}to.\

32. Sicut erat in princípio, et \textit{nunc}, \textit{et} \textbf{sem}per, \ast\  et in sǽcula sæ\textit{cu}\textit{ló}\textit{rum}. \textbf{A}men.\
