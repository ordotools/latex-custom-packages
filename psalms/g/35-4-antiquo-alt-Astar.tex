2. Quóniam dolóse egit in con\textit{spéc}\textit{tu} \textbf{e}jus: \ast\  ut inveniátur iníquitas \textit{e}\textit{jus} \textit{ad} \textbf{ó}dium.\

3. Verba oris ejus iníqui\textit{tas}, \textit{et} \textbf{do}lus: \ast\  nóluit intellígere \textit{ut} \textit{be}\textit{ne} \textbf{á}geret.\
