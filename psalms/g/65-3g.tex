2. Dícite Deo: Quam terribília sunt ópera \textbf{tu}a, \textbf{Dó}\textbf{mi}ne! \ast\  in multitúdine virtútis tuæ mentiéntur tibi ini\textit{mí}\textit{ci} \textbf{tu}i.\

3. Omnis terra adóret te, et \textbf{psal}lat \textbf{ti}bi: \ast\  psalmum dicat nó\textit{mi}\textit{ni} \textbf{tu}o.\

4. Veníte, et vidéte \textbf{ó}pera \textbf{De}i: \ast\  terríbilis in consíliis super fí\textit{li}\textit{os} \textbf{hó}minum.\
...
6. Qui dominátur in virtúte sua in ætérnum, óculi ejus super \textbf{Gen}tes re\textbf{spí}\textbf{ci}unt: \ast\  qui exásperant non exalténtur in \textit{se}\textit{met}\textbf{íp}sis.\
...
11. Transívimus per \textbf{i}gnem et \textbf{a}quam: \ast\  et eduxísti nos in \textit{re}\textit{fri}\textbf{gé}rium.\
...
14. Holocáusta medulláta ófferam tibi cum in\textbf{cén}so a\textbf{rí}\textbf{e}tum: \ast\  ófferam tibi bo\textit{ves} \textit{cum} \textbf{hir}cis.\
...
17. Iniquitátem si aspéxi in \textbf{cor}de \textbf{me}o, \ast\  non exáu\textit{di}\textit{et} \textbf{Dó}minus.\
