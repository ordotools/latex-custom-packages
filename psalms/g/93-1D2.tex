...
4. Effabúntur et loquéntur in\textbf{i}qui\textbf{tá}tem: \ast\  loquéntur omnes, qui operántur \textit{in}\textit{jus}\textbf{tí}\textbf{ti}am?\
...
8. Intellígite, insipi\textbf{én}tes in \textbf{pó}pulo: \ast\  et stulti, ali\textit{quán}\textit{do} \textbf{sá}\textbf{pi}te.\

9. Qui plantávit \textbf{au}rem, non \textbf{áu}diet? \ast\  aut qui finxit óculum, \textit{non} \textit{con}\textbf{sí}\textbf{de}rat?\

10. Qui córripit \textbf{Gen}tes, non \textbf{ár}guet: \ast\  qui docet hómi\textit{nem} \textit{sci}\textbf{én}\textbf{ti}am?\

11. Dóminus scit cogitati\textbf{ó}nes \textbf{hó}minum, \ast\  quón\textit{i}\textit{am} \textbf{va}\textbf{næ} sunt.\

12. Beátus homo, quem tu eru\textbf{dí}eris, \textbf{Dó}mine, \ast\  et de lege tua docú\textit{e}\textit{ris} \textbf{e}um.\

13. Ut mítiges ei a di\textbf{é}bus \textbf{ma}lis: \ast\  donec fodiátur pecca\textit{tó}\textit{ri} \textbf{fó}\textbf{ve}a.\
...
18. Si dicébam: Motus \textbf{est} pes \textbf{me}us: \ast\  misericórdia tua, Dómine, \textit{ad}\textit{ju}\textbf{vá}\textbf{bat} me.\
