...
27. Turbáti sunt, et moti sunt \textit{sic}\textit{ut} \textbf{é}brius:~*  et omnis sapiéntia eó\textit{rum} \textit{de}\textit{vo}\textbf{rá}\textbf{ta} est.\
...
41. Et adjúvit páuperem \textit{de} \textit{in}\textbf{ó}pia:~*  et pósuit sicut \textit{o}\textit{ves} \textit{fa}\textbf{mí}\textbf{li}as.\

42. Vidébunt recti, et \textit{læ}\textit{ta}\textbf{bún}tur:~*  et omnis iníquitas oppi\textit{lá}\textit{bit} \textit{os} \textbf{su}um.\

43. Quis sápiens et cus\textit{tó}\textit{di}\textbf{et} hæc?~*  et intélliget miseri\textit{cór}\textit{di}\textit{as} \textbf{Dó}\textbf{mi}ni.\
