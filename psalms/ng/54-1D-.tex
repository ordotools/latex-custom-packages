...
5. Timor et tremor ve\textbf{né}runt \textbf{su}per me: \ast\  et contexé\textit{runt} \textit{me} \textbf{té}nebræ.\

6. Et dixi: Quis dabit mihi pennas \textbf{sic}ut co\textbf{lúm}bæ, \ast\  et volábo, et \textit{re}\textit{qui}\textbf{és}cam?\

7. Ecce elon\textbf{gá}vi \textbf{fú}giens: \ast\  et mansi in \textit{so}\textit{li}\textbf{tú}dine.\
...
10. Die ac nocte circúmdabit eam super muros \textbf{e}jus in\textbf{í}quitas: \ast\  et labor in médio ejus, et \textit{in}\textit{jus}\textbf{tí}tia.\
...
24. Mollíti sunt sermónes ejus \textbf{su}per \textbf{ó}leum: \ast\  et ip\textit{si} \textit{sunt} \textbf{já}cula.\
