2. In die tribulatiónis meæ Deum exquisívi, \dag\  mánibus meis nocte \textbf{con}tra \textbf{e}um:~*  et non \textit{sum} \textit{de}\textbf{cép}tus.\

3. Rénuit consolári ánima mea: \dag\  memor fui Dei, et delectátus sum, et ex\textbf{er}ci\textbf{tá}\textbf{tus} sum:~*  et defécit spí\textit{ri}\textit{tus} \textbf{me}us.\
...
11. Memor fui \textbf{ó}perum \textbf{Dó}\textbf{mi}ni:~*  quia memor ero ab inítio mirabíli\textit{um} \textit{tu}\textbf{ó}rum.\
...
17. Etenim sagíttæ \textbf{tu}æ \textbf{tráns}\textbf{e}unt:~*  vox tonítrui tu\textit{i} \textit{in} \textbf{ro}ta.\
