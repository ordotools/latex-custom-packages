...
9. Et exsultavérunt fí\textit{li}\textit{æ} \textbf{Ju}dæ: \ast\  propter judíci\textit{a} \textit{tu}\textit{a}, \textbf{Dó}\textbf{mi}ne:\
...
12. Lux or\textit{ta} \textit{est} \textbf{jus}to, \ast\  et rectis \textit{cor}\textit{de} \textit{læ}\textbf{tí}\textbf{ti}a.\
