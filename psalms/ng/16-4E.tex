...
4. Probásti cor meum, et visi\textit{tás}\textit{ti} \textbf{noc}te:~*  igne me examinásti, et non est invénta \textit{in} \textit{me} \textit{in}\textbf{í}\textbf{qui}tas.\
...
9. A resisténtibus déxteræ tu\textit{æ} \textit{cus}\textbf{tó}di me,~*  ut \textit{pu}\textit{píl}\textit{lam} \textbf{ó}\textbf{cu}li.\

10. Sub umbra alárum tuárum \textit{pró}\textit{te}\textbf{ge} me:~*  a fácie impiórum qui \textit{me} \textit{af}\textit{fli}\textbf{xé}runt.\

11. Inimíci mei ánimam meam circumdedérunt, \dag\  ádipem suum \textit{con}\textit{clu}\textbf{sé}runt:~*  os eórum locú\textit{tum} \textit{est} \textit{su}\textbf{pér}\textbf{bi}am.\
