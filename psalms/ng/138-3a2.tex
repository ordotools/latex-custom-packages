...
7. Si ascéndero in \textbf{cæ}lum, tu \textbf{il}\textbf{lic} es: \ast\  si descéndero in in\textit{fér}\textit{num}, \textbf{ad}es.\

8. Si súmpsero pennas \textbf{me}as di\textbf{lú}\textbf{cu}lo, \ast\  et habitávero in ex\textit{tré}\textit{mis} \textbf{ma}ris.\

9. Etenim illuc manus \textbf{tu}a de\textbf{dú}\textbf{cet} me: \ast\  et tenébit me déx\textit{te}\textit{ra} \textbf{tu}a.\

10. Et dixi: Fórsitan ténebræ \textbf{con}cul\textbf{cá}\textbf{bunt} me: \ast\  et nox illuminátio mea in delí\textit{ci}\textit{is} \textbf{me}is.\

11. Quia ténebræ non obscurabúntur a te, \dag\  et nox sicut dies il\textbf{lu}mi\textbf{ná}\textbf{bi}tur: \ast\  sicut ténebræ ejus, ita et \textit{lu}\textit{men} \textbf{e}jus.\
...
20. Nonne qui odérunt te, \textbf{Dó}mine, \textbf{ó}\textbf{de}ram? \ast\  et super inimícos tuos \textit{ta}\textit{be}\textbf{scé}bam?\
