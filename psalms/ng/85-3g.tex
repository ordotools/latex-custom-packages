2. Custódi ánimam meam, \textbf{quón}iam \textbf{sanc}\textbf{tus} sum: \ast\  salvum fac servum tuum, Deus meus, spe\textit{rán}\textit{tem} \textbf{in} te.\
...
7. Non est símilis tui in \textbf{di}is, \textbf{Dó}\textbf{mi}ne: \ast\  et non est secúndum ó\textit{pe}\textit{ra} \textbf{tu}a.\

8. Omnes gentes quascúmque fecísti, vénient, et adorábunt \textbf{co}ram te, \textbf{Dó}\textbf{mi}ne: \ast\  et glorificábunt \textit{no}\textit{men} \textbf{tu}um.\

9. Quóniam magnus es tu, et fáciens \textbf{mi}ra\textbf{bí}\textbf{li}a: \ast\  tu es \textit{De}\textit{us} \textbf{so}lus.\
...
12. Quia misericórdia tua \textbf{ma}gna est \textbf{su}\textbf{per} me: \ast\  et eruísti ánimam meam ex inférno in\textit{fe}\textit{ri}\textbf{ó}ri.\
...
14. Et tu, Dómine, Deus miserátor \textbf{et} mi\textbf{sé}\textbf{ri}cors, \ast\  pátiens, et multæ misericórdi\textit{æ}, \textit{et} \textbf{ve}rax.\
