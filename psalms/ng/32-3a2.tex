2. Confitémini Dómi\textbf{no} in \textbf{cí}\textbf{tha}ra:~*  in psaltério decem chordárum psál\textit{li}\textit{te} \textbf{il}li.\

3. Cantáte ei \textbf{cán}ticum \textbf{no}vum:~*  bene psállite ei in vocife\textit{ra}\textit{ti}\textbf{ó}ne.\

4. Quia rectum est \textbf{ver}bum \textbf{Dó}\textbf{mi}ni,~*  et ómnia ópera e\textit{jus} \textit{in} \textbf{fi}de.\

5. Díligit misericórdiam \textbf{et} ju\textbf{dí}\textbf{ci}um:~*  misericórdia Dómini ple\textit{na} \textit{est} \textbf{ter}ra.\

6. Verbo Dómini \textbf{cæ}li fir\textbf{má}\textbf{ti} sunt:~*  et spíritu oris ejus omnis vir\textit{tus} \textit{e}\textbf{ó}rum.\
...
9. Quóniam ipse \textbf{di}xit, et \textbf{fac}\textbf{ta} sunt:~*  ipse mandávit, \textit{et} \textit{cre}\textbf{á}ta sunt.\
...
13. De cælo re\textbf{spé}xit \textbf{Dó}\textbf{mi}nus:~*  vidit omnes fí\textit{li}\textit{os} \textbf{hó}minum.\
...
20. Anima nostra \textbf{sús}tinet \textbf{Dó}\textbf{mi}num:~*  quóniam adjútor et pro\textit{téc}\textit{tor} \textbf{nos}ter est.\

21. Quia in eo lætábi\textbf{tur} cor \textbf{nos}trum:~*  et in nómine sancto e\textit{jus} \textit{spe}\textbf{rá}vimus.\

22. Fiat misericórdia tua, \textbf{Dó}mine, \textbf{su}\textbf{per} nos:~*  quemádmodum sperá\textit{vi}\textit{mus} \textbf{in} te.\
