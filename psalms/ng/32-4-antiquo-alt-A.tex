...
13. De cælo re\textit{spé}\textit{xit} \textbf{Dó}minus: \ast\  vidit omnes \textit{fí}\textit{li}\textit{os} \textbf{hó}minum.\
...
17. Fallax equus \textit{ad} \textit{sa}\textbf{lú}tem: \ast\  in abundántia autem virtútis su\textit{æ} \textit{non} \textit{sal}\textbf{vá}bitur.\
...
20. Anima nostra sús\textit{ti}\textit{net} \textbf{Dó}minum: \ast\  quóniam adjútor et \textit{pro}\textit{téc}\textit{tor} \textbf{nos}ter est.\

21. Quia in eo lætábi\textit{tur} \textit{cor} \textbf{nos}trum: \ast\  et in nómine sancto \textit{e}\textit{jus} \textit{spe}\textbf{rá}vimus.\
